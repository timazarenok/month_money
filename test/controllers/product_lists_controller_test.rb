...
class ProductListsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create product_list" do
    assert_difference('ProductList.count') do
      post product_lists_url, params: { product_list: { month_id: @product_list.month_id, value: @product_list.value, year: @product_list.year } }
    end
  ...
  test "should update product_list" do
    patch product_list_url(@product_list), params: { product_list: { month_id: @product_list.month_id, value: @product_list.value, year: @product_list.year } }
